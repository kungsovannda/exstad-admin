...
export function InterviewedEnrollmentTable<TValue>({
  columns,
  data,
  totalItems,
}: InterviewedEnrollmentTableProps<TValue>) {
  ...
  const [isMarkPassedModalOpen, setIsMarkPassedModalOpen] = useState(false);
  ...
  async function onMarkPassedHandle() {
    ...
    if (success + failure === selectedEnroll.length) {
      setTimeout(() => {
        setIsMarkPassedModalOpen(false);
      }, 3000);
    }
  }
  ...
  return (
    <DataTable table={table}>
      <DataTableToolbar table={table}>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={onMarkPassedHandle}>
              Mark as Passed
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      ...
      {isMarkPassedModalOpen && (
        <ModalProcess
          {...stateProcess}
          title="Please wait while we marking the enrollments as passed. This process may take a few moments."
          open={isMarkPassedModalOpen}
          onOpenChange={setIsMarkPassedModalOpen}
          beingGenerateMsg="Updating Enrollment..."
          completeGenerateMsg="Updating Complete"
          successMsg="enrollments marked as passed"
