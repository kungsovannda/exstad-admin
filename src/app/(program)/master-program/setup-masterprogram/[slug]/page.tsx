...
export default function ProgramSetup() {
  const [tab, setTab] = useState<"highlight"|"program-overview"|"curriculum" | "roadmap"|"learning-outcomes" | "course-requirements"|  "faq">("highlight");
  ...
  return (
    <div className="p-5">
      ...
      <div className="flex gap-4 mb-6 bg-accent p-2 rounded-[10px] w-fit">
        ...
        <Button variant={tab === "program-overview" ? "default": "outline"} onClick={() => setTab("program-overview")}>Program Overview</Button>
