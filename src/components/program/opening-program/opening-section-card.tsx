...
export function OpeningSectionCards() {
  return (
    <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-4 gap-4  *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs  @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
      <Card className="@container/card">
        <CardHeader> 
          <CardDescription>Total Opening Program</CardDescription>
      ...
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Closed Opening Program</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            17
          </CardTitle>
          <CardAction>
      ...
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Short Course</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            1
          </CardTitle>
          <CardAction>
